...
| **Info**|https://learn.microsoft.com/en-us/defender-xdr/advanced-hunting-devicenetworksevents-table|
...
| project Timestamp, DeviceName, Account, ActionType, FileName
...
## Created By:
- **Author Name**: Aldir
- **Author Contact**: https://github.com/21Aldir
- **Date**: April 15, 2026
...
## Additional Notes:
- Lab environment: Microsoft Azure Windows 10 VM
- Device Name: `aldir-1`
- User Account: `aldir`
- TOR Browser Version: 15.0.9 (Portable)
- Lab Purpose: Educational threat hunting exercise
- All data is from a controlled lab environment for training purposes
...
|-------------|-------------------------------|------------------|-------------------|
| 1.0         | Initial draft                  | `April 15, 2026`  | `Aldir`   |
